...
public:
  ...
  StackWalker(JavaThread* thread, frame top_frame, bool skip_c_frames = true, bool max_c_frames_skip = -1);

  StackWalker(JavaThread* thread, bool skip_c_frames = true, bool max_c_frames_skip = -1);
