 ...
 * @requires vm.jvmti
 * @run main/othervm/native -agentlib:AsyncGetStackTraceTest2 profiling.sanity.JFRLLBaseTest
 */

public class JFRLLBaseTest {
  static {
    try {
      System.loadLibrary("AsyncGetStackTraceTest2");
  ...
  /** check a simple native call which calls JFRLL */
